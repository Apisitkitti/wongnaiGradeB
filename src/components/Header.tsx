  ...
  return (
    <div className="header_container">
      <div className="header_left">
        <img src="../Wongnai_logo.png" alt="WebLogo" />
      </div>

      <div className="header_center">
        <div className="place_container">
          <img src="../pin.png" alt="location_pic" id="pin_img" />
          <input type="text" id="search_area" name="search_area" placeholder="กรุงเทพและปริมณฑล" />
          <img src="../dropdown_search.png" alt="dropdown_search" id="moreLocation_button" />
        </div>
        <div className="search_restaurant_container">
          ...
          <button className="search_but">
            <img src="../white_search.png" alt="search_pic" width="18px" />
          </button>
        </div>
      </div>
      ...
      <div className="header_right">
        ...
        <button className="dropdown_button">
          <img src="../dropdown_icon.png" alt="dropdown_icon" width="15px" />
        </button>
      </div>
    </div>
  );
